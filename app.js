  ...
  return `
    ...
    <div class="card">
      ...
      <div class="row" style="margin-bottom:10px;align-items:stretch">
        <input class="input" id="wVal" type="number" step="0.1" placeholder="体重 kg" value="${wRec ? wRec.value : ""}" style="flex:1;min-width:0;min-height:42px">
        <input class="input" id="wDate" type="date" value="${key}" style="flex:none;width:130px;min-height:42px">
      </div>
      <div class="row" style="margin-bottom:10px;align-items:stretch">
        <button class="btn" onclick="weightAdd()" style="flex:1;padding:10px;min-height:42px;justify-content:center;font-size:14px">保存</button>
        <button class="btn btn-danger" onclick="weightDel()" style="flex:1;padding:10px;min-height:42px;justify-content:center;font-size:14px">删除</button>
      </div>
